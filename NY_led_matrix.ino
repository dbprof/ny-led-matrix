/*
 * Скетч DIY "Светодиодная матрица вместо гирлянды на Новый Год"
 * Исходники на GitHub: https://github.com/dbprof/ny-led-matrix
 * По сравнению с GyverMatrixBT 1.12 изменено:
 * 1. Прошивка и обновление по воздуху блоки:
 *      1.1//////WIFI_INCLUDE///////
 *      1.2//////WIFI_SETUP/////////
 *      1.3//////WIFI_LOOP//////////
 * 2. Счетчик дней до Нового Года
 *      /////////COUNTER///////////
 */
